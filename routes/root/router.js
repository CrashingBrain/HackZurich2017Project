...
router.get('/', function(req, res, next) {
  if (req.accepts('text/html')) {
  	...
  	utils.doJSONRequest('GET', restURL2, null, null, function(news){
  		let newurui = news.versionedguid;
  		APIutils.doEntitiesRequest(newurui, function(ents){
  			console.log(ents);
  			console.log(APIutils.getEntitiesNames(ents));
  		});
  	});
    res.render('index', {
      title: "Nepeta",
